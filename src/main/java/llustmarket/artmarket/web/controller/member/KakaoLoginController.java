...
public class KakaoLoginController {
    ...
    public ResponseEntity<Object> confirmDuplicateKakao(@RequestBody @Valid kakadoDuplicateDTO request, BindingResult bindingResult) {
        ...
        try {
            ...
            checkDuplication("JoinNickname", request.getKakaoJoinNickname(), "닉네임", duplications);
            checkDuplication("JoinEmail", request.getKakaoJoinEmail(), "이메일", duplications);
            checkDuplication("JoinPhone", request.getKakaoJoinPhone(), "전화번호", duplications);
