...
public class NormalRegisterController {
    ...
    public String shownormalRegistrationForm(Model model) {
        model.addAttribute("member", new Member());
        return "member/normal_register";
    }

    @PostMapping("/normal/register")
    public String processnormalRegistrationForm(@Valid @ModelAttribute("member") Member member, BindingResult bindingResult, Model model) {
